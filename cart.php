...
<html>
    <head>
        <link rel="shortcut icon" href="img/33.jpg" />
        <title>AMRUTH Ecommercestore</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy Lifestyle Store. All Rights Reserved. | Contact Us: +8617641551738</p>
